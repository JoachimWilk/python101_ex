...
def ustawienia():
    """Funkcja pobiera nick użytkownika, ilość losowanych liczb,    
    maksymalną losowaną wartość oraz ilość prób. 
...
def wyniki(liczby, typy):
    ...
    if trafione:
        ...
        trafione2 = ", ".join(map(str, trafione))
        print "Trafione liczby: %s" % trafione2
    else:
